            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 print-receipt-container">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="hidden print:block text-center mt-6">
                        ...
                        <p class="text-sm font-bold" style="margin-top: 2mm;">Thank you for your business!</p>
                        <p class="text-[10px]">Generated by Invoice-Management-System</p>
                        <p class="text-[8px] mt-2 italic">on {{ now()->format('F d, Y') }}</p>
                    </div>
